                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle d-flex" href="#" id="languageDropdown" role="button"
                            ...
                            <img src="https://www.nobleui.com/html/template/assets/images/flags/us.svg" class="w-20px"
                                title="us" alt="flag">
                        ...
                        <div class="dropdown-menu" aria-labelledby="languageDropdown">
                            ...
                            <a href="javascript:;" class="dropdown-item py-2 d-flex"><img
                                    ...
                                    class="w-20px" title="de" alt="de"> <span class="ms-2">
                                    German
                                </span></a>
                            <a href="javascript:;" class="dropdown-item py-2 d-flex"><img
                            ...
                            <a href="javascript:;" class="dropdown-item py-2 d-flex"><img
                                    ...
                                    class="w-20px" title="es" alt="es"> <span class="ms-2">
                                    Spanish </span></a>
                        </div>
                    </li>
                    <li class="nav-item dropdown">
                ...
                <li class="nav-item">
                    ...
                    <div class="submenu">
                        <ul class="submenu-item">
                            ...
                            <li class="nav-item"><a class="nav-link" href="pages/email/inbox.html">Inbox</a>
                            </li>
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <ul>
                                                        ...
                                                        <li class="nav-item"><a class="nav-link"
                                                                href="pages/ui-components/tabs.html">Tabs</a>
                                                        </li>
                                                        <li class="nav-item"><a class="nav-link"
                                ...
                                <div class="submenu-item">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <ul>
                                                <li class="nav-item"><a class="nav-link"
                                                        href="pages/general/blank-page.html">Blank page</a>
                                                </li>
                                                <li class="nav-item"><a class="nav-link"
